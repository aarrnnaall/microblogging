    ...
    describe('Publication Service', () => {
        ...
        describe('Service methods', () => {
            ...
            it('should create a Publication', () => {
                service.create(new Publication(null)).subscribe(received => {
            ...
            it('should update a Publication', () => {
                service.update(new Publication(123)).subscribe(received => {
            ...
            it('should return a Publication', () => {
