    ...
    describe('Publicacion Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/publicacions';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Publicacion', () => {
                service.create(new Publicacion(null)).subscribe(received => {
            ...
            it('should update a Publicacion', () => {
                service.update(new Publicacion(123)).subscribe(received => {
            ...
            it('should return a Publicacion', () => {
